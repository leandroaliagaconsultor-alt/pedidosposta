export const getAppBackground = (template: string, customBg?: string) => {
    ...
    switch (template) {
        ...
        case 'neon_stack_pro': return '#09090b';
...
export const getCardClasses = (t: string) => {
    ...
    switch (t) {
        ...
        case 'neon_stack_pro':
            return base + "rounded-2xl bg-[#09090b]/90 border border-zinc-800 text-[#FAFAFA] hover:border-[var(--brand-color)]/50 transition-colors";
        case 'elegant-dark':
...
export const getButtonStyles = (t: string, primaryColor: string) => {
    ...
    if (t === 'neon-cyber' || t === 'neon_stack_pro') return { backgroundColor: primaryColor, boxShadow: `0 0 15px ${primaryColor}40`, color: '#09090b' };
...
export const getButtonClasses = (t: string) => {
    ...
    switch (t) {
        ...
        case 'neon_stack_pro': return base + "rounded-full font-black uppercase text-[#09090b] shadow-[0_0_20px_var(--brand-color)] hover:scale-[1.02] hover:shadow-[0_0_30px_var(--brand-color)]";
...
export const getCTAClasses = (t: string) => {
    ...
    switch (t) {
        ...
        case 'neon_stack_pro': return base + "rounded-none font-black uppercase tracking-widest text-[#09090b] shadow-[0_0_15px_var(--brand-color)] active:scale-95";
...
export const getAvatarClasses = (t: string) => {
    ...
    switch (t) {
        ...
        case 'neon_stack_pro': return base + "border-[#09090b] shadow-[0_0_40px_var(--brand-color)]";
